// src/components/Dashboard.tsx - Clean Fixed Version
...
const Dashboard: React.FC<DashboardProps> = ({
  ...
  return (
    ...
    >
      {/* Date Filter Section - Above announcements like in reference */}
      ...
      {/* Main content container with fixed filter panel on LEFT */}
      <div className="flex flex-1 min-h-0">
        
        {/* Fixed Filter Panel - LEFT Side */}
        <div className="w-80 flex-shrink-0 p-4">
          <FilterPanel className="h-fit max-h-full overflow-y-auto" />
        </div>

        {/* Main announcements content area */}
